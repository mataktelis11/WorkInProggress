...
void REPAIR(int day,Chain person,node* myApointers[],int index,int all_days){
        ...
        //         cout<<"gap:";
        //         int t1,t2,dt;
        //         t1=slow->time + (slow->hour)*60;
        //         t2=fast->time + (fast->hour)*60;
        //         dt=t2-t1;
        //         cout<<" dt is "<<dt<<endl;
        //         float d = sqrt( (slow->x - fast->x)*(slow->x - fast->x)  +  (slow->y - fast->y)*(slow->y - fast->y) );
        //         cout<<" d is "<<d<<endl;
        ...
        //         //find vx and vy
        //         float speedx,speedy;
        //         speedx = ( fast->x - slow->x )/dt;
        //         speedy = ( fast->y - slow->y )/dt;
        //         cout<<speedx<<" "<<speedy<<endl;
        //         int nodes = dt/30 - 1;
        //         cout<<"will add "<<nodes<<endl;

        //         float xa,ya,xt,yt,x,y;
        //         int ta,t,hour,sec;
        //         xa=slow->x;
        //         ya=slow->y;
        //         xt=fast->x;
...
for (int q = 0; q<size; q++)
    {
      ...
      //  REPAIR(g,people[0],myApointers,0,size);
       // people[0].display();
        ...
        SUMMARIZE_TRAJECTORY(g,43, people[0],344,myApointers,0, the_days);
